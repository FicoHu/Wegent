    ...
    *,
    ...
    if is_user_selected_kb:
        kb_priority = (
            ...
            "- When you need relevant passages or do not yet know which document matters, call\n"
            "  `knowledge_base_search` first to find the best-matching chunks.\n"
            "- When you need the content of a specific knowledge base document, call `read_document`\n"
            "  with `knowledge_base_id` and `document_id`.\n"
            "- Pass `knowledge_base_id` explicitly when calling knowledge tools.\n"
