...
"""
FastAPI application for Docker mode executor.

This module contains the FastAPI app and all HTTP endpoints for the executor.
It is only imported in Docker mode to avoid loading unnecessary dependencies
in local mode.
"""
