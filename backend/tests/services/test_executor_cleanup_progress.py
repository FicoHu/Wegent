...
class TestExecutorCleanupProgress:
    ...
    def test_cleanup_uses_persisted_cursor_for_primary_scan(self, job_service, test_db):
    ...
    def test_cursor_prefers_redis_value_when_available(self, test_db):
    ...
    def test_cursor_defaults_to_recent_week_start_when_uninitialized(self, test_db):
        ...
        test_db.add_all([old_subtask, recent_subtask])
        test_db.commit()
        test_db.refresh(recent_subtask)
