...
class JobService(BaseService[Kind, None, None]):
    ...
    def cleanup_stale_executors(self, db: Session) -> None:
        ...
        try:
            ...
            while (
                ...
                candidates = self._scan_candidate_subtasks_batch(
                    db=db,
                    cutoff=cutoff,
                    last_id=last_id,
                ...
                total_deleted += self._cleanup_executor_groups(
                    db=db,
    ...
    def _scan_candidate_subtasks_batch(
        ...
        *,
        ...
        """Load one ordered batch of expired subtasks eligible for cleanup."""
        return (
            db.query(Subtask)
            .filter(
                Subtask.id > last_id,
